 ...
 * 2024-01-02T23:22:10.763+01:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "userService",
                  wsdlLocation = "file:/home/seta/Documents/5A/SOA/HelpSoapApplication/src/main/resources/wsdl/user.wsdl",
...
public class UserService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/seta/Documents/5A/SOA/HelpSoapApplication/src/main/resources/wsdl/user.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/seta/Documents/5A/SOA/HelpSoapApplication/src/main/resources/wsdl/user.wsdl");
        }
        WSDL_LOCATION = url;
    }
